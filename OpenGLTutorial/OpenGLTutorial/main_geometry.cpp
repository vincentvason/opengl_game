...
void mainGeometry()
{
	...
	Shader shader_default("default_model2.vert", "default_model.frag", "default_model.geom");
	Shader shader_normal("default_model2.vert", "normal.frag", "normal.geom");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		statue.drawModel(shader_normal, camera);
